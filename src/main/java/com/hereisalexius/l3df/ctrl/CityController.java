...
/**
 * Created by hereisalexius on 5/6/16.
 */
...
public class CityController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        CanvasLinksContainer.cityCanvas = canvas;
        canvas.toFront();
        Brush b = new Brush(canvas, Color.RED, Color.WHITE);
        b.getPropertyMap().get("radius").bind(brushSizer.valueProperty());
        canvas.setOpacity(0.2);
        ...
        canvas.setOnMouseEntered(e -> {
            ...
            CanvasLinksContainer.woodCanvas.snapshot(sp,wim);
